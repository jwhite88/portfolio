            ...
            <div className='flex flex-row justify-around text-left'>
                <section className='w-1/3 releative ' >
                    <div id='aboutOne' ref={aboutOne} >
                        <h1 className='t text-5xl italic pt-5 pb-4' style={{ fontFamily: "Arima Madurai",textShadow: "1px 1px rgba(255,255,255,0.5)" }}>Passion...</h1>
                        <p className='leading-9 tracking-wide text-3xl ' id="para" style={{ fontFamily: "Laila", textShadow: "1px 1px rgba(255,255,255,0.5)", }}>
                ...
                <section id='mypg' className='w-1/3  releative ' >
                    <div id='aboutTwo' ref={aboutTwo}>
                        <h1 className='t text-5xl italic pt-5 pb-4' style={{ fontFamily: "Arima Madurai", textShadow: "1px 1px rgba(255,255,255,0.5)" }}>Understading...</h1>
                        <p className='leading-9 tracking-wide text-3xl ' id="paratwo" style={{
                            fontFamily: "Laila", textShadow: "1px 1px rgba(255,255,255,0.5)", }}>
